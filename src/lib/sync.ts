...
const TASK_COLUMNS = 'id, user_id, title, description, context, priority, energy, status, due_at, deleted_at, created_at, updated_at, completed_at, completed_at_confidence, resolution_type, resolved_at, estimated_minutes, actual_minutes, started_at, recurrence_rule, recurrence_origin_id, postponed_count, version';
